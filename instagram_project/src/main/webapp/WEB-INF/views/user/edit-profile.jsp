...
<%@ include file="../include/nav.jsp" %>
  ...
  <main id="edit-profile">
    <div class="edit-profile__container u-default-box">
      ...
      <form:form action="/user/UpdateProfile" method = "PUT" class="edit-profile__form">
        ...
        <div class="edit-profile__row">
          <label class="edit-profile__label" for="intro">Intro</label>
        ...
        <div class="edit-profile__row">
          <label class="edit-profile__label" for="phone">Phone Number</label>
